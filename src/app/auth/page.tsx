// src/app/auth/page.tsx (Previously src/app/page.tsx - Authentication Options)
"use client";
  ...
  return (
    <div className="relative flex flex-col items-center justify-end min-h-screen bg-background text-foreground p-4 pb-0 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Button variant="ghost" size="icon" className="absolute top-4 left-4 text-white hover:text-primary z-20" onClick={() => router.push('/')}>
